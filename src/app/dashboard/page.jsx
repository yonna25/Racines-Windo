...
const TABS = [
  ...
  { icon: '🌳', label: 'Arbre',        href: '/arbre' },
  { icon: '💬', label: 'Messages',     href: '/messages' },
  { icon: '📅', label: 'Événements',   href: '/evenements' },
  { icon: '👤', label: 'Profil',       href: '/galerie' },
]
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#FAF6EF', fontFamily: 'DM Sans, sans-serif' }}>
      ...
      {/* ── Corps ── */}
      <div className="flex-1 -mt-6 rounded-t-3xl px-5 pt-6 pb-28"
          ...
          {CARDS.map(c => (
            ...
            >
              ...
              <p className="font-semibold mb-1"
                 style={{ color: '#1B3A2F', fontFamily: 'Cormorant Garamond, serif', fontSize: 18 }}>
                {c.title}
              </p>
        ...
        <p className="text-xs tracking-[0.2em] uppercase mb-4" style={{ color: '#4A7C65' }}>
          PROCHAINS ÉVÉNEMENTS
        </p>
        <div className="flex flex-col gap-3">
          {EVENTS.map(e => (
            <button
              ...
              className="rounded-2xl px-4 py-4 flex items-center justify-between text-left w-full"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold"
                     style={{ color: '#1B3A2F', fontFamily: 'Cormorant Garamond, serif', fontSize: 16 }}>
                    {e.name}
                  </p>
          ...
          return (
            ...
            >
              ...
              <span className="text-xs"
                    style={{ color: active ? '#1B3A2F' : '#9A8878', fontWeight: active ? 600 : 400 }}>
                {t.label}
              </span>
              {active && <div className="w-1 h-1 rounded-full" style={{ background: '#C8A96E' }} />}
            </button>
          )
        })}
      </div>
